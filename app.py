...
# =========================================
# Configuration: Neon Color Palette
# =========================================
...
def create_risk_breakdown_chart(prob_percentage):
    ...
    # Marker color
    marker_color = COLOR_NEON_RED if prob_percentage < 55 else COLOR_NEON_ORANGE if prob_percentage < 70 else COLOR_NEON_GREEN
...
def create_simple_risk_bar(prob_percentage):
    ...
    if prob_percentage < 55:
        zone = "HIGH RISK"
        zone_color = COLOR_NEON_RED
    elif prob_percentage < 70:
        zone = "BORDERLINE"
        zone_color = COLOR_NEON_ORANGE
    else:
        zone = "APPROVED"
...
def create_feature_importance_chart(input_data):
    ...
    # Neon Palette
    colors = [COLOR_NEON_GREEN if score >= 70 else COLOR_NEON_ORANGE if score >= 50 else COLOR_NEON_RED for score in df['Score']]
